...
# Replace the values = 0 of broken counters by hourly means
...
# Replace the values = 0 for identified counters and periods
...
# Get train data and replace broken counters values
